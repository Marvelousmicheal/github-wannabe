      ...
      <HoverCard backgroundColor="#7ee787" direction="" left="0">
        <div className="md:flex flex-col md:space-y-20 flex-1 p-8 sm:p-10 lg:py-16 lg:pl-16 lg:pr-32 justify-between ">
          <p className=" text-xl md:text-2xl mb-6 font-medium text-[#7d8590]">
            <span className="text-white font-medium">GitHub Copilot</span> is
          ...
          <div>
            ...
            >
              ...
              <div
                ...
                } origin-right  transition ease-in duration-300 h-[2.5px] bg-white rounded-full`}
              ></div>
            </a>
          </div>
        </div>
        <div className=" rounded-s-lg flex-1 shadow-3xl">
          <div className="text-left border bg-gray-700 border-[#30363d] rounded-lg text-[#161b22] box-shadow-card-mktg md:mt-10 md:ml-0 sm:ml-10 sm:mr-10 mb-16 ml-3 mr-3">
            <div>
              <div className="overflow-x-auto pt-2 px-2 mb-0 border-b border-gray-600">
                <div className="flex items-center bg-gray-700 text-gray-500">
                  <button
                ...
                <div className="flex">
                  ...
                  >
                    ...
                    >
                      ...
                      <div className="rounded-tl-none  bg-[#1f6feb] absolute color-fg-on-emphasis rounded-md font-bold flex items-center js-type-row p-2 ">
                        <svg
                          width="16"
                          height="15"
                          viewBox="0 0 16 15"
              ...
              <div className={`p-4 relative bg-[#0d1117] ${selectedButton==="javascript" ? "": "hidden"}`}>
                    <div className='flex'>
                        <div className='text-[#6e7681] text-right'>
              ...
              <div className={`p-4 relative bg-[#0d1117] ${selectedButton==="go" ? "": "hidden"}`}>
                    <div className='flex'>
                        <div className='text-[#6e7681] text-right'>
                            {Array.from({ length: 7 }, (_, index) => (
                            <div className="pr-2" key={index + 1}>{index + 1}</div>
