...
import Product from "./Nav-content/Product";
import Solution from "./Nav-content/Solution";
import OpenSource from "./Nav-content/OpenSource";
        ...
        <div className="flex items-center max-lg:justify-between max-lg:flex-row-reverse ">
          <div className="flex justify-between items-center max-lg:w-full">
            <h3 className="lg:hidden">
              <a
                href=""
                className="px-2 py-[6px] border rounded-md hover:text-neutral-400 capitalize"
              >
                sign up
              </a>
            </h3>
            ...
            >
              <div
                className={`w-[23px] h-[2px] transition ease-in duration-300 bg-white mb-1  ${
              ...
              <div
                className={`w-[23px] h-[2px] transition ease-in duration-300 bg-white mb-1 ${
                  showNav
                    ? "-translate-x-3 opacity-0 mb-0"
                    : "mb-1 translate-x-0"
                }`}
              ></div>
              <div
                className={`w-[23px] h-[2px] transition ease-in duration-300 bg-white mb-1  ${
                  showNav ? "rotate-[135deg] mb-0 -translate-y-[11px]" : "rotate-0 mb-1"
                } `}
              ></div>
            </button>
          </div>
          ...
          >
            <div className="flex max-lg:flex-col lg:items-center lg:justify-between max-lg:justify-between max-sm:w-10/12 max-sm:mx-auto sm:ml-auto max-lg:w-[320px] lg:w-full max-lg:max-h-[500px]  overflow-y-auto lg:mb-0 max-lg:bg-white max-lg:rounded-lg">
              <nav className="mt-0 px-3 lg:px-6 text-[16px] mb-0 max-lg:py-10 max-lg:px-5" >
