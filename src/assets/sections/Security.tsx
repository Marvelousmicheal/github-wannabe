...
import Projects from '../security/Project'
...
const Security = ({}: Props) => {
  ...
  return (
    <div className='max-w-[1280px] mx-auto'  id="security">
        ...
        <div className='relative z-[1]'>
            ...
            <motion.div initial={{scale:0.9, opacity:0}} whileInView={{scale:1, opacity:1}} transition={{type:'tween'}} className='rounded-r-md overflow-hidden flex items-center'>
                <img className="responsive origin-bottom-right" width="1288" height="992" loading="lazy" decoding="async" alt="" aria-hidden="true" src="/illu-secret-scanning.webp" />
            </motion.div>
            </HoverCard>
        </div>
        <div className='flex flex-col md:flex-row gap-10 '>
                <HoverCard backgroundColor = '#939aff' direction='flex-col' left='0'>
                    ...
                    <div className='overflow-hidden rounded-s-lg'>
                        <img className="w-full h-auto js-build-in-item build-in-scale-fade build-in-animate" width="1209" height="890" loading="lazy" decoding="async" alt="" aria-hidden="true" src="/illu-dependabot.webp" />
                    </div>
                </HoverCard>
                <HoverCard backgroundColor = '#939aff' direction='flex-col' left='-400px'>
                    ...
                    <div className='overflow-hidden rounded-s-lg'>
                    <img className="w-full h-auto " width="1208" height="764" loading="lazy" decoding="async" alt="" aria-hidden="true" src="/illu-code-scanning.webp" />
                    </div>
                </HoverCard>
        </div>
    </div>
