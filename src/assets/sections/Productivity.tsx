...
import Feature from "../components/Productivity-content/Feature";
        ...
        <div className="flex md:pl-10 space-x-3 md:space-x-10">
          <div className="flex flex-col items-center">
            ...
            <motion.div
              ...
              className=" h-full w-[3px] ml-2 rounded-md bg-gradient-to-b from-[#7ee787]"
            ></motion.div>
          </div>
          ...
          <div className="md:w-10/12 mb-24 ">
            ...
            >
              ...
              <span className="text-red-500">LMAO.</span>
              Our AI-powered platform makes you question if you are actually{" "}
              <span className="text-red-500 uppercase">smart</span> enough to be
              a developer.
            </motion.h3>
          </div>
        </div>
              ...
              >
                <div className="md:flex flex-col flex-1 p-8 sm:p-10 lg:py-16 lg:pl-16 lg:pr-32 ">
                  <p className=" text-xl md:text-2xl mb-6 font-medium text-[#7d8590]">
                    ...
                    automates your build, test, and deployment workflow with
